<section class="py-24 bg-white text-slate-900 overflow-hidden" id="services">
    <div class="container mx-auto px-6 md:px-10 max-w-7xl">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div
                class="group p-8 rounded-3xl bg-white border border-slate-100 shadow-sm hover:shadow-xl hover:-translate-y-2 transition-all duration-500 animate-on-scroll opacity-0 translate-y-10 delay-100 transition-all duration-1000">
                <div
            ...
            <div
                class="group p-8 rounded-3xl bg-white border border-slate-100 shadow-sm hover:shadow-xl hover:-translate-y-2 transition-all duration-500 animate-on-scroll opacity-0 translate-y-10 delay-200 transition-all duration-1000">
                <div
            ...
            <div
                class="group p-8 rounded-3xl bg-white border border-slate-100 shadow-sm hover:shadow-xl hover:-translate-y-2 transition-all duration-500 animate-on-scroll opacity-0 translate-y-10 delay-300 transition-all duration-1000">
                <div
            ...
            <div
                class="group p-8 rounded-3xl bg-white border border-slate-100 shadow-sm hover:shadow-xl hover:-translate-y-2 transition-all duration-500 animate-on-scroll opacity-0 translate-y-10 delay-400 transition-all duration-1000">
                <div
